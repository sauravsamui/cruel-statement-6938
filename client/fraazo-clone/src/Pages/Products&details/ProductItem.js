...
const ProductItem = (props) => {
  ...
  return (
    <>
        ...
        <div className={styles.product_each_items} key={props.el._id}>
       { props.loading && <div className="container ">
        ...
        {!props.loading && <><Link to={`/productsdetails/${props.el._id}`}><img style={{ width: "100" }} src={props.el.src} alt="product_image" 
        /></Link>
        <Link to={`/productsdetails/${props.el._id}`}> <div>{props.el.name}</div></Link>
       <div className={styles.product_each_items_priceButton}>
       <Link to={`/productsdetails/${props.el._id}`}><div>
            <div
              style={{
                fontSize: "13px",
            ...
            >
             { `${props.el.quantity} qty`}
            </div>
            <div style={{ fontWeight: "500" }}>₹ {props.el.price}</div>
          </div></Link>
          <div>
            {addedToCart ? (
              <div
